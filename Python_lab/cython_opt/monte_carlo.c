...
#define __PYX_HAVE__monte_carlo
#define __PYX_HAVE_API__monte_carlo
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from "monte_carlo" */
static double __pyx_v_11monte_carlo_pi;
static double __pyx_f_11monte_carlo_random_gauss(void); /*proto*/
static double __pyx_f_11monte_carlo_price_european_call(double, double, double, double, double, int, int __pyx_skip_dispatch); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "monte_carlo"
extern int __pyx_module_is_main_monte_carlo;
int __pyx_module_is_main_monte_carlo = 0;

/* Implementation of "monte_carlo" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_11monte_carlo_price_european_call(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_S0, double __pyx_v_K, double __pyx_v_T, double __pyx_v_r, double __pyx_v_sigma, int __pyx_v_num_paths); /* proto */
...
static double __pyx_f_11monte_carlo_random_gauss(void) {
  double __pyx_v_u1;
  double __pyx_v_u2;
  double __pyx_v_z0;
  double __pyx_r;
 ...
 * 
*/
  __pyx_v_z0 = (sqrt((-2.0 * log(__pyx_v_u1))) * cos(((2.0 * __pyx_v_11monte_carlo_pi) * __pyx_v_u2)));
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("monte_carlo.random_gauss", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
static PyObject *__pyx_pw_11monte_carlo_1price_european_call(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_11monte_carlo_price_european_call(double __pyx_v_S0, double __pyx_v_K, double __pyx_v_T, double __pyx_v_r, double __pyx_v_sigma, int __pyx_v_num_paths, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_sum_payoffs;
  double __pyx_v_drift;
  double __pyx_v_vol;
  double __pyx_v_z;
  double __pyx_v_ST;
  double __pyx_v_payoff;
...
*/
  __pyx_v_drift = ((__pyx_v_r - (0.5 * pow(__pyx_v_sigma, 2.0))) * __pyx_v_T);
 ...
 *     cdef int i
*/
  __pyx_v_vol = (__pyx_v_sigma * sqrt(__pyx_v_T));
 ...
 *         payoff = ST - K
*/
    __pyx_t_4 = __pyx_f_11monte_carlo_random_gauss(); if (unlikely(__pyx_t_4 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
    __pyx_v_z = __pyx_t_4;
 ...
 *         if payoff > 0:
*/
    __pyx_v_ST = (__pyx_v_S0 * exp((__pyx_v_drift + (__pyx_v_vol * __pyx_v_z))));
 ...
 *             sum_payoffs += payoff
*/
    __pyx_v_payoff = (__pyx_v_ST - __pyx_v_K);
...
*/
      __pyx_v_sum_payoffs = (__pyx_v_sum_payoffs + __pyx_v_payoff);
 ...
 *     return exp(-r * T) * (sum_payoffs / num_paths)             # <<<<<<<<<<<<<<
*/
  if (unlikely(__pyx_v_num_paths == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 28, __pyx_L1_error)
  }
  __pyx_r = (exp(((-__pyx_v_r) * __pyx_v_T)) * (__pyx_v_sum_payoffs / ((double)__pyx_v_num_paths)));
  goto __pyx_L0;
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("monte_carlo.price_european_call", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
static PyMethodDef __pyx_mdef_11monte_carlo_1price_european_call = {"price_european_call", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_11monte_carlo_1price_european_call, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_11monte_carlo_1price_european_call(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("price_european_call (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_S0,&__pyx_mstate_global->__pyx_n_u_K,&__pyx_mstate_global->__pyx_n_u_T,&__pyx_mstate_global->__pyx_n_u_r,&__pyx_mstate_global->__pyx_n_u_sigma,&__pyx_mstate_global->__pyx_n_u_num_paths,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "price_european_call", 0) < (0)) __PYX_ERR(0, 14, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 6; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("price_european_call", 1, 6, 6, i); __PYX_ERR(0, 14, __pyx_L3_error) }
      }
    ...
    __pyx_v_S0 = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_S0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_K = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_K == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_T = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_T == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_r == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    ...
    __pyx_v_num_paths = __Pyx_PyLong_As_int(values[5]); if (unlikely((__pyx_v_num_paths == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("price_european_call", 1, 6, 6, __pyx_nargs); __PYX_ERR(0, 14, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_11monte_carlo_price_european_call(__pyx_self, __pyx_v_S0, __pyx_v_K, __pyx_v_T, __pyx_v_r, __pyx_v_sigma, __pyx_v_num_paths);
...
static PyObject *__pyx_pf_11monte_carlo_price_european_call(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_S0, double __pyx_v_K, double __pyx_v_T, double __pyx_v_r, double __pyx_v_sigma, int __pyx_v_num_paths) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("price_european_call", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_11monte_carlo_price_european_call(__pyx_v_S0, __pyx_v_K, __pyx_v_T, __pyx_v_r, __pyx_v_sigma, __pyx_v_num_paths, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L1_error)
...
static int __pyx_pymod_exec_monte_carlo(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_monte_carlo},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_monte_carlo(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_monte_carlo(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_monte_carlo(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'monte_carlo' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "monte_carlo" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_monte_carlo", 0);
  ...
  if (__pyx_module_is_main_monte_carlo) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "monte_carlo")) {
      if (unlikely((PyDict_SetItemString(modules, "monte_carlo", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * cdef double random_gauss():
*/
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_math); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_pi); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = __Pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_4 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_11monte_carlo_pi = __pyx_t_4;
 ...
 *     cdef double drift = (r - 0.5 * sigma**2) * T
*/
  __pyx_t_3 = __Pyx_CyFunction_New(&__pyx_mdef_11monte_carlo_1price_european_call, 0, __pyx_mstate_global->__pyx_n_u_price_european_call, NULL, __pyx_mstate_global->__pyx_n_u_monte_carlo, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_3);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_price_european_call, __pyx_t_3) < (0)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init monte_carlo", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init monte_carlo");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{15},{1},{20},{2},{1},{12},{18},{18},{8},{13},{5},{8},{4},{10},{11},{8},{9},{2},{3},{19},{12},{1},{12},{10},{5},{8},{6},{131}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (355 bytes) */
const char* const cstring = "BZh91AY&SYxN\2254\000\000\032\177\363\366n9)x\005z\200\274\r~\000\277\357\377`\000@@@@@@@@\000@\0000\001\030\024EM\031\006 \302i\211\220\320\032i\246@\300\231\003\321\251\246\3248\311\223&#\023\000&L\023 \006\214#\000C\000\324\310LMM\252x\215\023A\240\320\000\032\000\032\036\223\031\245\027e\226Y`Lb\206\306\344\201\010^I\"W\275b\202\225* EzJ\306e%e1\224\346\240\240W]'\242\025k\363\257\225\306\266\2677\317\266z\327n\255\013\250\264\225\245\\\034\032\240\342I\020B\213Y ,\215\237\307\010\334\3049\253\004\346G\025Xq\273m\362\2424\244\251W\252\341S\301\325:\014P\372